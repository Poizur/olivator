...
CREATE TABLE IF NOT EXISTS gsc_snapshot (
  ...
  key2        TEXT NOT NULL DEFAULT '',          -- druhý klíč pro query+page ('' = neuvedeno)
...
CREATE UNIQUE INDEX IF NOT EXISTS gsc_snapshot_unique_idx
  ON gsc_snapshot(taken_at, dimension, key1, key2);
