      ...
      {reports.length === 0 && (
        <div className="bg-white border border-off2 rounded-[var(--radius-card)] p-8 text-center">
          ...
          <div className="text-[11px] text-text3 italic mt-4 bg-off rounded-lg px-3 py-2 inline-block">
            Pokud vidíš tuto zprávu i po spuštění → tabulka <code className="bg-off2 px-1 rounded">manager_reports</code> možná neexistuje.
            Aplikuj migraci <code className="bg-off2 px-1 rounded">supabase/migrations/20260428_manager_reports.sql</code>.
          </div>
        </div>
      )}
