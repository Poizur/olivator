...
export const ARTICLES: Article[] = [
  ...
  { slug: 'nejlepsi-olivovy-olej-2025', title: 'Nejlepší olivový olej 2026: žebříček podle dat', category: 'zebricek', excerpt: 'Nezávislé srovnání olivových olejů dostupných v ČR podle Olivator Score — kyselost, polyfenoly, certifikace, cena za 100 ml. Aktualizováno pro rok 2026.', readTime: '15 min čtení', emoji: '🏆' },
