    ...
    <div className="bg-white border border-off2 rounded-[var(--radius-card)] p-6">
      <div className="flex items-start justify-between mb-4 gap-4">
        ...
        <button
          ...
          className="bg-off border border-off2 rounded-full px-3 py-1.5 text-[12px] font-medium hover:border-olive-light hover:text-olive disabled:opacity-40 transition-colors whitespace-nowrap"
        >
          ...
          {facts.map((fact, i) => (
            ...
            >
              ...
              <button
                ...
                className="text-text3 hover:text-terra text-sm"
                title="Smazat"
              >
                ✕
              </button>
...
function ImportanceSelect({
  ...
  const bg =
    value === 'high'
      ...
      : value === 'medium'
      ? 'bg-terra-bg text-terra border-terra/30'
