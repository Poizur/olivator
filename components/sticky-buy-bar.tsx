...
// Sticky Buy Bar — produktová stránka.
// Mobil: full-width bar přilepený dole, z-[2010] překryje compare bar (z-[2000]).
// Desktop (lg+): floating pill v pravém dolním rohu, Apple-styled.
// Viditelné po scrollu > 600px aby nepřebíjelo hero.
...
export function StickyBuyBar({
  ...
  return (
    <>
      {/* ── Mobil: full-width bar dole ── */}
      <div
        aria-hidden={!visible}
        className={`lg:hidden fixed bottom-0 left-0 right-0 z-[2010] flex items-center justify-between gap-3 bg-white/97 backdrop-blur-md border-t border-off2 px-4 py-3 transition-transform duration-300 ${
