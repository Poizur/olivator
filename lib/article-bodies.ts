...
|---|---|---|
| **Kyselost** | 35 % | Volné mastné kyseliny v %. Pod 0,2 % = max body. |
| **Polyfenoly + chemie** | 25 % | mg/kg total polyphenols, peroxidové číslo, K232/K270 |
| **Certifikace** | 25 % | DOP/CHOP, BIO, PGP, NYIOOC ocenění |
| **Cena za 100 ml** | 15 % | Fair value — ne nejlevnější, ale rozumný za danou třídu |

Detailní [metodika](/metodika) je veřejná, můžete si Score sami přepočítat.

### Co NEHODNOTÍME

- **Marketingové claim** ("prémiový", "ručně sbíraný" bez evidence)
- **Brand recognition** — Bertolli může být horší než neznámá řecká farma
- **Obal a design** — krásný flakon nemá nic společného s kvalitou oleje uvnitř
- **Subjektivní chuť** — pikantnost, hořkost, ovocnost. To je věc preference, ne kvality. Pro chuťové preference nabízíme [flavor selector](/srovnavac).

### Zdroje dat

Strukturovaná data scrapujeme z e-shopů (Shoptet/WooCommerce parametr tabulky), web výrobců, **Open Food Facts API**, **EU DOOR** (DOP/CHOP databáze) a **NYIOOC** výsledky. Cenová data aktualizujeme každý den. Lab analýzy se přebírají z certifikátů přiložených k jednotlivým produktům.

## Top 5 olejů 2026 — celkový žebříček

> Score se mění s každým rescrape (typicky týdně). Aktuální top vidíte vždy v [žebříčku](/zebricek/nejlepsi-olivovy-olej-2025).

### 1. SITIA Kréta PREMIUM GOLD 0,2 % — Score 85

**Proč vyhrává:** Kombinace [Kréta DOP](/oblast/kreta), kyselost 0,26 %, polyfenoly 646 mg/kg a férová cena 32 Kč/100 ml v 5l plechu. Žádný jiný olej dostupný v ČR nedosahuje této kombinace.

Krétské oleje obecně dominují nízkou kyselostí (suché léto, brzká sklizeň), SITIA Premium Gold je vlajková loď. **Plech místo skla** je technicky lepší — UV neprobíhá, oxidace pomalejší. Dostupný u řeckých specialty e-shopů.

[Detail produktu →](/olej/sitia-kreta-premium-gold-0-2-extra-panensky-olivovy-olej-5-l)

### 2. EVOLIA PLATINUM BIO 250 ml — Score 77

**Pro koho:** Kdo bere olivový olej jako **funkční potravinu**, ne ingredienci. Polyfenoly **2 012 mg/kg** — to je 4× víc než průměrný "kvalitní" EVOO, 10× víc než supermarket olej. Dle EFSA je 5 mg hydroxytyrosolu denně → ochrana LDL před oxidací. Z Evolia Platinum stačí 1 polévková lžíce.

[Peloponés](/oblast/peloponnes), BIO certifikace, kyselost 0,2 %. Cena 716 Kč/100 ml = drahý, ale lžičkou denně vás flakon vydrží 3 měsíce.
...
### 4. Iliada Kalamata DOP 500 ml — Score 62

**Nejdostupnější top kvalita.** Kalamata DOP, kyselost 0,5 %, široce dostupná v Rohlíku, Košíku i specializovaných e-shopech za ~280 Kč. Pro někoho první kvalitní olej "mimo Bertolli", aniž by musel hledat specialty obchody.

[Iliada](/znacka/iliada) jako značka má dlouhou tradici — pokud někoho zajímá brand story, doporučujeme jejich [stránku](/znacka/iliada).

### 5. Intini EXTRA Alberobello 500 ml — Score 60

Apulie, polyfenoly 903 mg/kg, blend [Coratina](/odruda/coratina) + [Cima di Mola](/odruda/cima-di-mola) (autochtonní apulijská odrůda). Vyvažuje Coratina pálivost s ovocnějším profilem Cima di Mola. Cena ~520 Kč/500 ml.

## Nejlepší olivový olej podle ceny

### Do 200 Kč — best value

V této cenovce nečekejte premium kvality, ale **slušné EVOO** s kyselostí pod 0,5 %. Cíl: něco lepšího než supermarket bez nutnosti specialty obchodu.

- **Iliada Kalamata 500 ml** za ~280 Kč překračuje tento limit, ale je nejblíž ideálu cena/kvalita
- **Sitia 1 l** v rozumné kvalitě za ~390 Kč → ~39 Kč/100 ml
- Pro 1l flašku počítejte minimálně 250 Kč pro DOP-certified olej

[Filtrovat oleje pod 200 Kč →](/srovnavac?price=200)

### Do 400 Kč — sweet spot

Tato kategorie je pro většinu lidí ideální. Dostanete DOP/PGP certifikaci, kyselost pod 0,3 %, dobrou čerstvost (sklizeň loňského podzimu).

Doporučujeme:
- **SITIA Kréta 1 l** ~390 Kč
- **Iliada Kalamata** ~280 Kč
- **Intini Classico 500 ml** ~340 Kč

[Filtrovat oleje 200–400 Kč →](/srovnavac?price=400)

### Premium nad 500 Kč

Pro dárek nebo vlastní zvláštní použití (lžička denně, finishing dressing). Zde se vyplatí jít po **vysokých polyfenolech** (>1000 mg/kg) nebo unikátní odrůdě.

- **EVOLIA PLATINUM** — 2012 mg/kg polyfenolů, na lžičky
- **Intini Oro** — limitovaná edice, dárkové balení
- **Sitia Premium Gold 5 l** — cena 1590 Kč ale 32 Kč/100 ml = nejlepší dlouhodobá investice

## Nejlepší olivový olej podle původu
...
[Itálie](/srovnavac?origin=it) má prestižnější brand, ale **buďte opatrní s cenou**. Italské oleje pod 200 Kč/litr jsou typicky směs dovezeného severoafrického oleje stáčené v Itálii. **Hledejte DOP nebo IGP označení** — to je garance původu.

Top regiony: [Apulie](/oblast/apulie) (60 % italské produkce, DOP Bitonto, Cima di Bitonto), [Toskánsko](/oblast/toskansko) (DOP Toscano, dražší ale prestižní), [Sicílie](/oblast/sicilie).

### Španělský a portugalský olej

Španělsko je #1 producent na světě, ale v ČR je dostupnost slabší. Pokud najdete **Picual** ([odrůda](/odruda/picual)) z Andalusie, mívá výborné polyfenoly. Portugalské oleje z [Alentejo](/oblast/alentejo) jsou málo zastoupené, ale kvalitní.
...
**SITIA Kréta 5 l** — 1590 Kč zní jako hodně, ale 32 Kč/100 ml je ekvivalent supermarketového Bertolli. Při tomto rozdílu kvality (Score 85 vs ~40) je to nejlepší ROI nákup.

## Co v žebříčku NENAJDETE — a proč

### Známé značky z TV reklamy

Bertolli, Filippo Berio, Carapelli — **většinou nesplňují prahové hodnoty**. Marketing platí supermarketové umístění a TV spoty, ne kvalitu uvnitř lahve. Pokud máte rádi neutrální chuť, je to OK volba pro fritování. Pro salát zkuste cokoli s DOP/IGP označením.

### "Italské" oleje pod 200 Kč/litr

Téměř jistě **směs dovezeného oleje** ze severní Afriky nebo Španělska, jen stáčená v Itálii. Bez DOP/IGP nemáte garanci původu. Etikity tohoto typu obsahují klauzuli "olive oils from EU and non-EU countries" (mixed origin).

### Oleje bez data sklizně

Pokud výrobce **neuvádí harvest date** (typicky podzim/zima), něco skrývá. Olivový olej má 18–24 měsíců "best by", ale **kvalitativně klesá od měsíce 6**. Bez data nemůžete ověřit čerstvost. V našem žebříčku zobrazujeme harvest date u každého produktu, kde je dostupné.

### Oleje s nejasným původem

Některé "Toskánské" nebo "Andaluské" oleje na e-shopech jsou bez konkrétního výrobce a regionu. Pravděpodobně bulk dodávky bez garance. Preferujeme oleje s **konkrétním výrobcem** (značka), **konkrétním regionem** (DOP/IGP) a **harvest year**.

## Jak žebříček sledovat

- **Týdně** (pondělí 4:00 UTC) — discovery agent prochází 19+ e-shopů, scrapuje aktuální ceny a dostupnost
- **Při nových produktech** — když se objeví nový kvalitní olej v jakémkoli e-shopu, dostane Score do 24 hodin
- **Při sezonní změně sklizně** (listopad–prosinec) — top oleje obnovují harvest date, polyfenoly se mírně mění, Score přepočítáváme

[Newsletter Olivový týden](/) každé pondělí: olej týdne, slevy, jakékoli změny v top 5.

## Často kladené otázky

### Jaký olivový olej je nejlepší pro běžné vaření?

Pro běžné vaření (smažení do 180 °C, dušení) doporučujeme **Iliada Kalamata DOP** nebo **SITIA Kréta 1 l**. Mají kyselost pod 0,5 %, jsou dostupné a férová cena ~280–390 Kč. Pro fritování (nad 180 °C) se hodí jakýkoli rafinovaný "olive oil" — drahé EVOO se v takovém teplu beztak rozpadne.

### Vyplatí se kupovat olivový olej v 5l plechu?

**Ano**, pokud ho spotřebujete do 6 měsíců. Plech chrání před UV a kyslíkem lépe než sklo, cena za 100 ml je o 30–50 % nižší než v 250ml lahvi. Skladujte v chladu (12–18 °C) a temnu.

### Co znamená kyselost 0,2 % a proč na ní záleží?

Kyselost je **podíl volných mastných kyselin** v oleji. Vzniká během skladování oliv před lisováním a samotného lisování. **Nižší = lepší**: pod 0,2 % = excelentní (brzká sklizeň, rychlé zpracování), 0,2–0,5 % = velmi dobrá, 0,8 % = limit pro označení "extra panenský". Nad 0,8 % už není EVOO, ale "panenský".

### Co jsou polyfenoly a kolik by měl olivový olej mít?

Polyfenoly jsou **antioxidační sloučeniny** s prokázanými zdravotními benefity. EFSA uznává minimum **250 mg/kg** pro health claim "olive polyphenols protect blood lipids from oxidative stress" při 20g denní dávce. Kvalitní EVOO má 200–500 mg/kg, "high phenolic" třída 750+ mg/kg, výjimečné oleje (EVOLIA PLATINUM) přes 2000 mg/kg. Více v článku [Polyfenoly v olivovém oleji](/pruvodce/polyfenoly-proc-na-nich-zalezi).

### Je BIO olivový olej automaticky lepší?

**Ne**. BIO znamená pouze způsob pěstování (bez pesticidů, bez umělých hnojiv), neříká nic o **kvalitě lisování ani čerstvosti**. Najdete BIO oleje s kyselostí 0,8 % stejně jako konvenční s 0,2 %. Pro zdraví preferujte BIO + nízkou kyselost + vysoké polyfenoly. Více v [Jak vybrat olivový olej](/pruvodce/jak-vybrat-olivovy-olej).

### Kde olivový olej skladovat?

V **chladu (12–18 °C)** a **temnu**. Žádný luxus — ne na kuchyňské lince u sporáku, ale do skříňky nebo do spíže. Ideálně **tmavé sklo nebo plech** (ne plast, ne čiré sklo). Po otevření spotřebovat do 2–3 měsíců, bez ztráty kvality.

### Je dražší olej automaticky lepší?

**Ne**. Cena je ovlivněna brand marketingem, distributorskou marží a obalem stejně jako kvalitou samotného oleje. **Iliada Kalamata 280 Kč** překonává mnohé italské oleje za 600 Kč. Naopak EVOLIA PLATINUM 2150 Kč/250 ml je drahá, ale unikátní (2012 mg/kg polyfenolů). Hodnotu posuďte vždy podle Olivator Score, ne ceny.

## Závěr — náš výběr pro 2026

Pro **každodenní vaření**: [SITIA Kréta 1 l](/oblast/kreta) nebo [Iliada Kalamata](/znacka/iliada).

Pro **dárek** nebo zvláštní příležitost: [Intini Coratina](/znacka/intini) nebo [SITIA Premium Gold 5 l](/srovnavac).

Pro **zdravotní lžičku denně**: [EVOLIA PLATINUM 2012 mg/kg polyfenolů](/srovnavac?quality=high_polyphenols).

Žebříček a ceny jsou aktuální k dnešnímu dni. [Spustit srovnávač](/srovnavac) — najděte si vlastního favorita podle vlastních filtrů (typ, původ, certifikace, cena).
`.trim(),
