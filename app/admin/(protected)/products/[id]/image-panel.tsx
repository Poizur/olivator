        ...
        <div className="bg-off rounded-lg p-3">
          ...
          {preview.kind === 'idle' && (
            <button
              ...
              disabled={loading}
              className="bg-white border border-off2 rounded-full px-3 py-1.5 text-[12px] font-medium hover:border-olive3 hover:text-olive transition-colors"
            >
              🔍 Zobrazit náhled
            </button>
          )}
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="bg-white border border-off2 rounded-full px-3 py-1.5 text-[11px] font-medium hover:border-terra hover:text-amber-700 transition-colors"
                >
                  ✕ Zamítnout
                </button>
              </div>
