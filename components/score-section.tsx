...
export function ScoreSection({ product, children }: { product: Product; children?: ReactNode }) {
  ...
  return (
    <>
      <div className="bg-off rounded-xl p-5 mb-5">
        ...
        {/* children = SSR breakdown (ScoreBreakdownSSR) předaný z page.tsx — viditelný AI crawlerům v raw HTML.
            Fallback = client-side rows (původní chování) pro stránky kde children není předáno. */}
        {children ?? (
